...
function validateReport(body) {
  ...
  if (!isNonEmptyString(body.host)) {
    return { ok: false, error: 'host is required (non-empty string)' };
  }
  ...
  if (body.runtime != null) {
    ...
    if (body.runtime.npm != null && String(body.runtime.npm).trim()) {
      runtime.npm = String(body.runtime.npm).trim();
    }
